    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-card to-background p-4 md:p-8">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="bg-card border border-border rounded-lg shadow-sm p-8 mb-8 text-center">
          <div className="mb-4">
            <span
              className={`inline-block px-4 py-1 rounded-full text-sm font-semibold text-white ${difficultyColor}`}
            >
              {difficultyLabel}
            </span>
          </div>
                ...
                >
                  ...
                  {isExpanded && (
                    <div className="px-4 pb-4 border-t border-border/30">
                      <p className="text-sm md:text-base text-foreground mb-4 mt-4 font-bold">
                        {q.question}
                      </p>
